...
- :icon:`oi-text-inline` (:guilabel:`Image alignment`): Select the following image alignments:

  - :icon:`oi-text-inline` (:guilabel:`inline`): Align the image in line with the surrounding text.
...
- :icon:`fa-file-image-o` (:guilabel:`Replace`): Replace the image by searching in the :doc:`Unsplash
