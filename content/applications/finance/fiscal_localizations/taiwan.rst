...
- :guilabel:`Individual` (B2C): Fill in the individual's :guilabel:`name` and provide the
  :guilabel:`Email` or :guilabel:`Phone` number.
- :guilabel:`Company` (B2B): Fill in the company :guilabel:`name`, enter the :guilabel:`Tax ID`,
  and provide the :guilabel:`Email` or :guilabel:`Phone` number.
