...
.. note::
   - The fields available in the :guilabel:`Credentials` tab depend on the payment provider. Refer
     ...
     information.
   - Once the payment provider has been enabled the payment provider, it is automatically published
     on the website. To unpublish it, click the :guilabel:`Published` button. Customers cannot make
...
Select specific :guilabel:`Pricelists` that can apply to the payment provider. Leaving the field
