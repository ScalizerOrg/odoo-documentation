...
- Click :guilabel:`Reverse and Create invoice` to create a credit note automatically validated and
  reconciled with the related invoice, and to open a new draft invoice prefilled with the exact
