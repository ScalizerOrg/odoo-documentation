...
.. important::
   ...
   - When using :doc:`Local Network Access <pos_lna>`, the ePOS printer must have a
...
The following printers require an :doc:`IoT system </applications/general/iot>` to be compatible
with Odoo:
