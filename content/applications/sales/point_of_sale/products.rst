...
.. note::
   Enabling the :guilabel:`Is Upsell` option removes the :guilabel:`Includes items` field, and
   consists of making a product optional inside the combo. However, selecting the optional product
   automatically adds the amount of the :guilabel:`Combo Price` to the total price.
