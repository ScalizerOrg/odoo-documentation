...
As soon as the internet connection is not longer active, a :guilabel:`Working offline` button
...
Buttons that are *not* available offline are automatically greyed out.
