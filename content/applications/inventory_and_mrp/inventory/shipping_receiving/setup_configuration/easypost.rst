...
Set up the EasyPost shipping connector in Odoo to manage EasyPost shipments to clients directly
within Odoo.
...
#. :ref:`Set up the shipping method in Odoo <inventory/shipping_receiving/easypost-method>`.
...
With those necessary credentials, configure the EasyPost shipping method in Odoo by going to
:menuselection:`Inventory app --> Configuration --> Shipping Methods`.

On the *Shipping Methods* page, click :guilabel:`New`.
...
Product`, refer to the :ref:`Delivery method
<inventory/shipping_receiving/shipping-methods-details>` documentation.
...
Save the shipping method by clicking the :icon:`fa-cloud-upload` :guilabel:`(Save manually)` icon.
...
- :guilabel:`Unpublished/Published`: determines if this shipping method is available on the user's
  **eCommerce** website.
