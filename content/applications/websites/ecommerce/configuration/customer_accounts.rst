...
.. note::
   - Customer contacts created through guest checkout are :guilabel:`Archived` in the backend by
     default. Once the customer creates an account, the relevant contact form becomes unarchived.
